...
<body>
  <div class="form-container">
    <form class="fr" action="register_backend.php" method="post">
      <h1 class="elem"><br>北部雲帳號註冊</h1>
  
      <div class="username-container">
        <label for='username'>用戶名:</label>
        <input type="text" id="username" name="username" placeholder="你全中文名字" class="elem" required>
      </div>

      <div class='phone-container'>
        <label for='phone'>電話號碼:</label>
        <input type="text" id="phone" name="phone" class="elem" placeholder="0956781234" required>
      </div>
      
      <div class='email-container'>
        <label for='email'>電子郵件:</label>
        <input type="email" id="email" name="email" class="elem" placeholder="你的電子郵件@gmail.com" required>
      </div>
